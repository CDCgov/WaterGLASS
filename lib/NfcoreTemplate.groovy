...
class NfcoreTemplate {
    ...
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            ...
            ${colors.blue}   ____                  _        _   _      _    ${colors.reset}
            ${colors.blue}  / ___|_ __ _   _ _ __ | |_ ___ | \\ | | ___| |_  ${colors.reset}
            ${colors.blue} | |   | '__| | | | '_ \\| __/ _ \\|  \\| |/ _ \\ __| ${colors.reset}
            ${colors.blue} | |___| |  | |_| | |_) | || (_) | |\\  |  __/ |_  ${colors.reset}
            ${colors.blue}  \\____|_|   \\__, | .__/ \\__\\___/|_| \\_|\\___|\\__| ${colors.reset}
            ${colors.blue}           __|___/|_|__ ___ ____                  ${colors.reset}
            ${colors.blue}           \\ \\      / / ___/ ___|                 ${colors.reset}
            ${colors.blue}            \\ \\ /\\ / / |  _\\___ \\                 ${colors.reset}
            ${colors.blue}             \\ V  V /| |_| |___) |                ${colors.reset}
            ${colors.blue}              \\_/\\_/  \\____|____/                 ${colors.reset}
