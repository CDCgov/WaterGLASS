//
// This file holds several functions specific to the main.nf workflow in the CDCgov/WDPB_CryptoSSU pipeline
//
...
class WorkflowMain {
    ...
    public static String citation(workflow) {
        return "If you use ${workflow.manifest.name} for your analysis please cite:\n\n" +
            "* The pipeline\n" +
            "  https://github.com/CDCgov/WDPB_CryptoSSU\n\n" +
    ...
    public static String help(workflow, params, log) {
        def command = "nextflow run ${workflow.manifest.name} --input samplesheet.csv --outdir <OUTDIR> -profile singularity"
        def help_string = ''
