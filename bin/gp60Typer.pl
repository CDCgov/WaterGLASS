...
#Modified: MHS 03-14-2024 for use with Nextflow
...
my $MIN_IDENT = 97;
my $MIN_LEN = 700;
my $MIN_COV; #This will be set depending if WGS or Sanger
...
#NCE Error messages
my $SEQ_ERR_MSG = "Sequence not found."; #Blast didnt return sequence
...
## Output ##
my $header = "Sample Name\tgp60_Subtype\tFasta_Header\tDatabase_Best_Match\tLength(bp)\t";
